...
const Player = () => {
    const {
        ...
        isLooping, toggleLoop, isShuffling, toggleShuffle,  volume, changeVolume
    } = useContext(PlayerContext);

    return track ? (
        <div className='h-[10%] bg-black flex justify-betwwen items-center text-white px-4'>
            ...
            <div className='flex flex-col items-center gap-1 m-auto'>
                <div className='flex gap-4'>
                    ...
                    <img
                        ...
                        src={isShuffling ? assets.shuffle_green_icon : assets.shuffle_icon} alt="Shuffle"
                    />
                    ...
                    <img
                        onClick={toggleLoop}
                        className={`w-4 cursor-pointer`}
                        src={isLooping ? assets.loop_green_icon  : assets.loop_icon} alt="Loop"
                    />
                </div>
